...
def drawStone(color, x, y):
    ...
    #=========================================================
    #
    # Draw stones at px, py(pixel coordinates of x, y)
    # Check stone at gameBoard(BLACK|WHITE)
    # Check if the coordinate is already taken by other stone
    # use canDraw to check that.
    # implement codes here.
    #
    #=========================================================
